...
def parse_args():
    ...
    parser.add_argument('--vision_tower_path', type=str, default=None, help='Local path to SigLIP vision tower model')
        ...
        for _, dataset_name in enumerate(args.data):
            ...
            if model is None and args.model_path != "":
                model_kwargs = {
                    ...
                    'is_process_image': args.is_process_image,
                    'processed_image_path': args.processed_image_path,
                    'max_step': args.max_step,
                    'bias_value': args.bias_value,
                    'rag_model_path': args.rag_model_path
                }
                if args.vision_tower_path is not None:
                    model_kwargs['vision_tower_path'] = args.vision_tower_path
                model = supported_VLM[model_name](**model_kwargs)
