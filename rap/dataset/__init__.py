import warnings
warnings.filterwarnings("ignore", message="MiniCPMForCausalLM")

from .image_base import ImageBaseDataset
from .image_mcq import ImageMCQDataset, CustomMCQDataset, HRBenchDataset, VStarDataset
...
IMAGE_DATASET = [
    ImageMCQDataset, HRBenchDataset, VStarDataset
]
